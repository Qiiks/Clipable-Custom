...
func (c *clips) FindMany(ctx context.Context, user *models.User, mods ...qm.QueryMod) (models.ClipSlice, error) {
	return models.Clips(modelsx.NewBuilder().Add(
		qm.Select(models.ClipColumns.ID, models.ClipColumns.Title, models.ClipColumns.Description, models.ClipColumns.Unlisted, models.ClipColumns.CreatorID, models.ClipColumns.CreatedAt, models.ClipColumns.Views, models.ClipColumns.Processing),
	).
		Add(mods...).
...
func (c *clips) SearchMany(ctx context.Context, user *models.User, query string) (models.ClipSlice, error) {
	return models.Clips(modelsx.NewBuilder().
		Add(qm.Select(models.ClipColumns.ID, models.ClipColumns.Title, models.ClipColumns.Description, models.ClipColumns.Unlisted, models.ClipColumns.CreatorID, models.ClipColumns.CreatedAt, models.ClipColumns.Views, models.ClipColumns.Processing),
